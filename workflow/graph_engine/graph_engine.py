...
from workflow.entities.node_entities import AgentNodeStrategyInit, NodeRunResult
from workflow.entities.variable_pool import VariablePool
from workflow.entities.workflow_node_execution import WorkflowNodeExecutionMetadataKey, WorkflowNodeExecutionStatus
from workflow.graph_engine.condition_handlers.condition_manager import ConditionManager
from workflow.graph_engine.entities.event import (
    BaseAgentEvent,
    BaseIterationEvent,
    BaseLoopEvent,
    GraphEngineEvent,
...
from workflow.graph_engine.entities.graph import Graph, GraphEdge
...
from workflow.graph_engine.entities.runtime_route_state import RouteNodeState
from workflow.nodes import NodeType
from workflow.nodes.agent.agent_node import AgentNode
from workflow.nodes.agent.entities import AgentNodeData
from workflow.nodes.answer.answer_stream_processor import AnswerStreamProcessor
from workflow.nodes.answer.base_stream_processor import StreamProcessor
from workflow.nodes.base import BaseNode
from workflow.nodes.end.end_stream_processor import EndStreamProcessor
from workflow.nodes.enums import ErrorStrategy, FailBranchSourceHandle
from workflow.nodes.event import RunCompletedEvent, RunRetrieverResourceEvent, RunStreamChunkEvent
# from libs.datetime_utils import naive_utc_now
# from libs.flask_utils import preserve_flask_contexts
# from models.enums import UserFrom
# from models.workflow import WorkflowType
from workflow.workflow_entry import WorkflowType, SimpleUserFrom, SimpleInvokeFrom
...
class GraphEngine:
    ...
    def __init__(
        ...
        thread_pool_max_submit_count = MAX_SUBMIT_COUNT
                            ...
                            if run_result.status == WorkflowNodeExecutionStatus.FAILED:
                                ...
                                if node.retry and retries < max_retries:
                                    ...
                                    yield NodeRunRetryEvent(
                                        ...
                                        retry_index=retries,
                                        start_at=time.time(), #naive_utc_now(),
                                        node_version=node.version(),
                                    )
